...
import { MachineController } from "../controller/machine.controller.js";
import { errorHandler } from "../factory/error.factory.js";

const router = express.Router();
const controller = GeneralFactory.create(MachineRepository, MachineService, MachineController);
