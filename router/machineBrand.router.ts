...
import { MachineBrandRepository } from "../repository/machineBrand.repository.js";
import { MachineBrandService } from "../service/machineBrand.service.js";
import { MachineBrandController } from "../controller/machineBrand.controller.js";
import { errorHandler } from "../factory/error.factory.js";

const router = express.Router();
const controller = GeneralFactory.create(MachineBrandRepository, MachineBrandService, MachineBrandController);
...
export { router as MachineBrandRouter };
